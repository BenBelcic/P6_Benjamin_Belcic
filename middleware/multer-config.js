...
const storage = multer.discStorage({                            // multer.discStorage pour enregistrer sur le disque
...
module.exports = multer({ storage: storage }).single('image');   // on exporte le middleware, ça correspondera à l'objet { storage } 
